import 'dart:convert';
import 'package:bedtimestories/home.dart';
import 'package:bedtimestories/register.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  loginHandle(String email, pass) async {
                        ...
                        InkWell(
                          child: Container(
                            ...
                            child: Material(
                              ...
                              child: InkWell(
                                onTap: ShareData.emailController.text == "" || ShareData.passwordController.text == "" ? null : () {
                                  setState(() {
                                    _isLoading = true;
                                  });
                                  loginHandle(ShareData.emailController.text, ShareData.passwordController.text);
                                },
                                child: Center(
                                  child: Text("LOGIN",
                                      style: TextStyle(
